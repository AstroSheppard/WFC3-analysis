...
from platon.new_transit_depth_calculator import TransitDepthCalculator
...
class CombinedRetriever:
        ...
        try:
            if measured_transit_depths is not None:
                ...
                transit_wavelengths, calculated_transit_depths, info_dict = transit_calc.compute_depths(
                    ...
                    part_size=part_size, ri=ri, cloud_fraction=cloud_fraction, full_output=True)
                """
    ...
    def get_default_fit_info(Rs, Mp, Rp, T=None, logZ=0, CO_ratio=0.53,
                             ...
                             cloud_fraction=1.,offset=0.,offset2=0, offset3=0,
